...
export default function ProductForm({
  ...
  const [Group_Prod, setGroup_Prod] = useState([]);
  ...
  async function saveProduct(ev) {
    ...
    if (_id) {
      //update
      await axios.put('/api/Group_products', {...data,_id});
    } else {
      //create
      await axios.post('/api/Group_products', data);
    }
    setGoToProducts(true);
  }
  if (goToProducts) {
    router.push("/Group_Prod");
  }
