  ...
  return (
    <Layout>
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href="/Group_Prod/new">
          <div className="btn-primary">Add New Group</div>
        </Link>
      </div>
        ...
        <tbody>
          {currentProducts.map((product) => (
            <tr key={product._id} className="border-b">
              ...
              <td className="py-2 px-4">
                <Link href={`/Group_Prod/edit/${product._id}`}>
                ...
                <Link href={`/Group_Prod/delete/${product._id}`}>
